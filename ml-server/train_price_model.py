...
PRICE_DATA_DIR = os.path.join(BASE_DIR, 'price-data')
...
df.to_csv(os.path.join(PRICE_DATA_DIR, 'agmark_prices.csv'), index=False)
...
# Save models
print("\n💾 Saving models...")
joblib.dump(xgb_model, os.path.join(MODEL_DIR, 'price_model.pkl'))
...
joblib.dump(models, os.path.join(MODEL_DIR, 'ensemble_models.pkl'))
...
print("\n" + "=" * 50)
print("✅ Training complete! Start the ML server with: python app.py")
print("=" * 50)
