...
Give concise, practical farming advice for today. Cover:
1. Irrigation needs (should they water crops today?)
2. Disease/pest risk given humidity and temperature
3. One immediate action the farmer should take

Keep it under 80 words. Be direct and practical. Use simple language.`;
