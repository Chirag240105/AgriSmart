...
export const PricesPage = () => {
  // Dashboard prices (6 default crops)
  ...
  // ── Fetch dashboard prices on mount ─────────────────
  useEffect(() => {
    (async () => {
      try {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          ML-powered price predictions · XGBoost model · Updated live
        </p>
      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-2xl">
                        ...
                        : price.product === 'Rice'   ? '🍚'
                        : price.product === 'Maize'  ? '🌽'
                        : price.product === 'Potato' ? '🥔'
                        : price.product === 'Onion'  ? '🧅'
                        : price.product === 'Tomato' ? '🍅' : '🌿'}
                      </span>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter your crop details to get a tailored ML price forecast
          </CardDescription>
        </CardHeader>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">per quintal · {prediction.season} season</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-3 mt-3 pt-3 border-t border-gray-200">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-semibold">{prediction.factors?.temperature_c}°C</p>
                </div>
                <div className="text-center">
